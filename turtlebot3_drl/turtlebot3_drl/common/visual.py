...
if ENABLE_VISUAL:
    ...
    class DrlVisual(pg.GraphicsLayoutWidget):
        def __init__(self, state_size, hidden_size):
            ...
            self.hidden_sizes = [hidden_size, int(hidden_size * 2), hidden_size // 2, hidden_size, hidden_size // 2, hidden_size // 2 ** 2, hidden_size // 2,
                                int(hidden_size * 2), int(hidden_size * 2), hidden_size, hidden_size // 2, hidden_size // 2 ** 2, hidden_size // 2 ** 3]
            ...
            titles = ['Raw Lidar 1', 'Raw Lidar 2', ' Raw Lidar 3', 'Feature 1', 'Feature 2', 'Env States 1', 'Env States 2', 'All 1', 'All 2',
